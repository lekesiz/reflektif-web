          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-6">
                Bilimsel ve Metodolojik Yaklaşımımız
              </h1>
              <p className="text-lg text-neutral-600 leading-relaxed">
                Reflektif, sadece pratik değil, aynı zamanda bilimsel olarak da sağlam temellere dayanır. Değerlendirme sistemimiz, psikometri alanında dünyada en çok kabul gören teorileri temel alır.
              </p>
            </div>
            ...
            <div className="relative">
              <div className="relative w-full h-[360px] rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/images/pages/bilimsel-temel-hero.webp"
